...
| ----------------------------------- | ---------------------------- | --------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| Identificadores vs. Palavras-chave  | `if`, `end`, `abc`           | Palavras-chave também obedecem ao padrão de identificadores     | Palavras-chave têm **precedência** sobre identificadores                            |
...
| operadores            | `==\|!=\|<=\|>=\|=\|<\|>\|%\|\+\|-\|\*\|/`                                                                                                                       |
| delimitadores         | `\(                                                                                                                                                              | \)       | \[  | \]  | \{  | \}  | ;   | ,   | \.` |
| palavras-chave        | `Keep\|as\|static\|show\|if\|elsif\|then\|end\|during\|ForEach\|to\|repeat\|until\|define\|regress\|integer\|floatingPoint\|string\|boolean\|null\|and\|or\|not` |
...
- Se encontrar /_ mas nunca encontrar _/, o analisador deve:
  - Gerar erro.
